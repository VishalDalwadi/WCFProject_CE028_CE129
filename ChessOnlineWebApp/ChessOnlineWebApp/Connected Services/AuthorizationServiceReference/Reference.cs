...
namespace ChessOnlineWebApp.AuthorizationServiceReference {
    ...
    public partial class AuthorizationFault : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ChessOnlineWebApp.AuthorizationServiceReference.AuthorizationFault.AuthorizationFaultType FaultTypeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ChessOnlineWebApp.AuthorizationServiceReference.AuthorizationFault.AuthorizationFaultType FaultType {
            get {
    ...
    public interface IAuthorizationService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(ChessOnlineWebApp.AuthorizationServiceReference.AuthorizationFault), Action="http://tempuri.org/IAuthorizationService/AuthorizeUserAuthorizationFaultFault", Name="AuthorizationFault", Namespace="http://schemas.datacontract.org/2004/07/AuthorizationService")]
        ChessOnlineWebApp.AuthorizationServiceReference.User AuthorizeUser(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAuthorizationService/AuthorizeUser", ReplyAction="http://tempuri.org/IAuthorizationService/AuthorizeUserResponse")]
        System.Threading.Tasks.Task<ChessOnlineWebApp.AuthorizationServiceReference.User> AuthorizeUserAsync(string token);
    }
    ...
    public partial class AuthorizationServiceClient : System.ServiceModel.ClientBase<ChessOnlineWebApp.AuthorizationServiceReference.IAuthorizationService>, ChessOnlineWebApp.AuthorizationServiceReference.IAuthorizationService {
        ...
        public ChessOnlineWebApp.AuthorizationServiceReference.User AuthorizeUser(string token) {
            return base.Channel.AuthorizeUser(token);
        }
        
        public System.Threading.Tasks.Task<ChessOnlineWebApp.AuthorizationServiceReference.User> AuthorizeUserAsync(string token) {
