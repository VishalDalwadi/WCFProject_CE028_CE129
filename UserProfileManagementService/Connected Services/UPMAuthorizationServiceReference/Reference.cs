...
namespace RegistrationService.UPMAuthorizationServiceReference {
    ...
    public partial class AuthorizationFault : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private RegistrationService.UPMAuthorizationServiceReference.AuthorizationFault.AuthorizationFaultType FaultTypeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public RegistrationService.UPMAuthorizationServiceReference.AuthorizationFault.AuthorizationFaultType FaultType {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="UPMAuthorizationServiceReference.IAuthorizationService")]
    public interface IAuthorizationService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(RegistrationService.UPMAuthorizationServiceReference.AuthorizationFault), Action="http://tempuri.org/IAuthorizationService/AuthorizeUserAuthorizationFaultFault", Name="AuthorizationFault", Namespace="http://schemas.datacontract.org/2004/07/AuthorizationService")]
        RegistrationService.UPMAuthorizationServiceReference.User AuthorizeUser(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAuthorizationService/AuthorizeUser", ReplyAction="http://tempuri.org/IAuthorizationService/AuthorizeUserResponse")]
        System.Threading.Tasks.Task<RegistrationService.UPMAuthorizationServiceReference.User> AuthorizeUserAsync(string token);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAuthorizationServiceChannel : RegistrationService.UPMAuthorizationServiceReference.IAuthorizationService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AuthorizationServiceClient : System.ServiceModel.ClientBase<RegistrationService.UPMAuthorizationServiceReference.IAuthorizationService>, RegistrationService.UPMAuthorizationServiceReference.IAuthorizationService {
        ...
        public RegistrationService.UPMAuthorizationServiceReference.User AuthorizeUser(string token) {
            return base.Channel.AuthorizeUser(token);
        }
        
        public System.Threading.Tasks.Task<RegistrationService.UPMAuthorizationServiceReference.User> AuthorizeUserAsync(string token) {
